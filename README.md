...
As you're working on the project, please make sure your README file includes the following:

The Python version you used
Python 3.13

Step-by-step instructions to run your code
1. Download the .ipynb file from the github and extract if needed.
2. Go to the Jupyter notebook and upload the ipynb file, select the 3.13 (XPython) kernel when opening the notebook.
3. Click the run button once, when prompted input the desired number of disks / n variables.
